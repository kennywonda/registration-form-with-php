...
//signup verification
  if (isset($_POST["signup"])){
    ...
    //to make sure password and confirm password is the same use md5
  ...
  // sign in verification
    if (isset($_POST["signin"])){
      ...
      if (mysqli_num_rows($check_email) >0){
        ...
        "<script> alert ('Login details is incorrect. please try again');</script>";
      }
    ...
    <div class="container">
        ...
        <div class="signin-signup">
          <form action="" method="post" class="sign-in-form">
            ...
            <div class="input-field">
              ...
              <input type="password" placeholder="Password" name="password" value= "<?php echo $_POST["passowrd"]; ?>" required/>
            </div>
          ...
          <form action="" class="sign-up-form" method="post">
            ...
            <div class="input-field">
              <i class="fas fa-user"></i>
              <input type="text" placeholder="Fullname" name="signup_full_name" value ="<?php echo $_POST["signup_full_name"]; ?>" required/>
            </div>
            <div class="input-field">
      ...
      <div class="panels-container">
        ...
        <div class="panel right-panel">
          ...
          <img src="img/reg.jpg" class="image" alt="" />
        </div>
      </div>
    </div>
